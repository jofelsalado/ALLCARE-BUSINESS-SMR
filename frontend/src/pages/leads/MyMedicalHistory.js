...
const MyMedicalHistory = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((result) => {
        setMyMedicalHistory(result.data);
      })
      ...
      <div class="flex flex-row min-h-screen bg-gray-100 text-gray-800">
        ...
        <main class="main flex flex-col flex-grow md:ml-0 transition-all duration-150 ease-in">
          ...
          <div class="main-content flex flex-col flex-grow p-4 ">
            <h1 class="font-bold text-2xl text-gray-700">MY MEDICAL HISTORY</h1>
            <div className="flex flex-row gap-5 flex-wrap">
              {myMedicalHistory.map((data, key) => (
                <Card className="h-64 w-[32%] overflow-hidden transition-opacity hover:opacity-90">
                  ...
                  <BsFillTrashFill
                    ...
                    className="bg-red-600 h-14 w-14 rounded-lg text-white absolute top-[40%] right-[30%] transform(-50%, -50%) cursor-pointer"
                  />
                  <AiOutlineEye
